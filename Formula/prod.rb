...
class Prod < Formula
    ...
    on_macos do
      if Hardware::CPU.arm?
        url "https://ithjwwsjhdziqnxrwydg.supabase.co/storage/v1/object/public/cli-binaries/releases/v0.0.2/prod-v0.0.2-darwin-arm64.gz"
...
bin.install "prod-v0.0.2-darwin-arm64" => "prod"
      ...
      if Hardware::CPU.intel?
        url "https://ithjwwsjhdziqnxrwydg.supabase.co/storage/v1/object/public/cli-binaries/releases/v0.0.2/prod-v0.0.2-darwin-amd64.gz"
...
bin.install "prod-v0.0.2-darwin-amd64" => "prod"
    ...
    on_linux do
      if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
        url "https://ithjwwsjhdziqnxrwydg.supabase.co/storage/v1/object/public/cli-binaries/releases/v0.0.2/prod-v0.0.2-linux-arm64.gz"
...
bin.install "prod-v0.0.2-linux-arm64" => "prod"
      ...
      if Hardware::CPU.intel?
        url "https://ithjwwsjhdziqnxrwydg.supabase.co/storage/v1/object/public/cli-binaries/releases/v0.0.2/prod-v0.0.2-linux-amd64.gz"
